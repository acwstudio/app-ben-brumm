...
namespace App\Http\Admin\Inserts\InsertColour\Requests;

use Domain\Inserts\Insert\Models\Insert;
use Domain\Inserts\InsertColour\Models\InsertColour;
use Illuminate\Foundation\Http\FormRequest;

final class InsertColourUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'data.attributes.name'          => ['sometimes','required','string','unique:insert_colours,name'],
